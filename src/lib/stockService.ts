...
function generateRealisticMockData(symbol: string, period: string): StockData {
  ...
  const realisticPrices: { [key: string]: number } = {
    ...
    'PERSISTENT.BSE': 5000.00,
    'COFORGE.BSE': 4000.00,
    'LALPATHLAB.BSE': 2000.00,
    'METROPOLIS.BSE': 1500.00,
    'FORTIS.BSE': 300.00,
    'MAXHEALTH.BSE': 500.00,
    'NARAYANKH.BSE': 2000.00,
    'STAR.BSE': 400.00,
    'INDIANHUME.BSE': 2000.00,
    'CROMPTON.BSE': 300.00,
    'HAVELLS.BSE': 1200.00,
    'CROMPTON.BSE': 300.00,
    'VOLTAS.BSE': 800.00,
    'BLUESTARCO.BSE': 500.00,
    'WHIRLPOOL.BSE': 2000.00,
    'AMBER.BSE': 3000.00,
    'ORIENTELEC.BSE': 200.00,
    'SUZLON.BSE': 15.00,
    'TATAPOWER.BSE': 200.00,
    'ADANIPOWER.BSE': 300.00,
    'NTPC.BSE': 180.00,
    'POWERGRID.BSE': 200.00,
    'TATACOMM.BSE': 2000.00,
    'BHARTIARTL.BSE': 950.00,
    'JIO.BSE': 200.00,
    'RAILTEL.BSE': 200.00,
    'TATACOMM.BSE': 2000.00,
